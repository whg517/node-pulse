...
`, logFile)
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "start", "--config", tmpFile)
...
`, logFile)
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "stop", "--config", tmpFile)
	output, err := cmd.CombinedOutput()
	if err != nil {
...
`, logFile)
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "status", "--config", tmpFile)
	output, err := cmd.CombinedOutput()
	if err != nil {
...
`, logFile)
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "debug", "--config", tmpFile)
	output, err := cmd.CombinedOutput()
	if err != nil {
...
`, logFile)
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "debug", "--pretty", "--config", tmpFile)
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestIntegration_InvalidCommandError(t *testing.T) {
	...
	cmd := exec.Command("go", "run", "../cmd/beacon", "invalid-command")
