...
- 验证 Pulse Agent 与 Pulse Core 协同架构的可行性
...
**Pulse Agent**
- ➕ 注册模式(接入 Pulse Core,接收动态配置)
- ➕ 配置优先级(Core 下发配置 > 本地配置)
- ➕ ICMP Ping 探测(可选协议)
- ➕ MTR 探测(逐跳路由分析)
- ➕ Traceroute 探测(多协议追踪)
- ➕ Iperf3 探测(带宽性能测试)
...
- ➕ 双向认证机制(Agent 与 Core 通信认证)
- ➕ 定期安全扫描与漏洞修复

**非功能**
- ✅ 配置数据采用 MySQL/PostgreSQL 存储
