...
export default function SessionsPage() {
  ...
  return (
    <PageContainer>
      ...
      <div className="mt-6 rounded-lg border border-[var(--color-brand-muted)] bg-[var(--color-brand-muted)] p-4">
        <div className="flex">
          <div className="flex-shrink-0">
            <svg className="h-5 w-5 text-[var(--color-brand)]" viewBox="0 0 20 20" fill="currentColor">
              <path
                fillRule="evenodd"
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-[var(--color-brand)]">{t('sessions.securityTips')}</h3>
            <div className="mt-2 text-sm text-[var(--color-brand)]">
