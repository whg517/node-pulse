...
export function AlertRuleDialog({ mode, initialData, nodes, onSubmit, onCancel }: AlertRuleDialogProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border border-gray-200 dark:border-slate-700 shadow-lg rounded-md bg-white dark:bg-slate-800 max-w-lg w-full">
        {/* Dialog Header */}
